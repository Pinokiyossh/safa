...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLOGIN FACEBOOK DULU SAYANG \x1b[1;91m[\xe2\x98\x86]'
        ...
        try:
            ...
            print '\n\x1b[1;91m[!] Koneksi Internet Luh Gak Stabil Bangsat...!!!'
            keluar()
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://instagram.com/official_pinokiyo')
                time.sleep(2)
                menu()
